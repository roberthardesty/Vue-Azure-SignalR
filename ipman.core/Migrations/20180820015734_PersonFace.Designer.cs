...
namespace ipman.core.Migrations
{
    ...
    [Migration("20180820015734_PersonFace")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ipman.shared.Entity.FaceCollection", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("FaceCollection");
                });

            modelBuilder.Entity("ipman.shared.Entity.FaceImage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("FaceCollectionID");

                    b.Property<bool>("IsActive");

                    b.HasKey("ID");

                    b.HasIndex("FaceCollectionID");
            ...
            modelBuilder.Entity("ipman.shared.Entity.Join.SiteAccountUserAccount", b =>
                {
                    ...
                    b.ToTable("SiteAccountUserAccounts");
            ...
            modelBuilder.Entity("ipman.shared.Entity.Person", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ipman.shared.Entity.SiteAccount", b =>
                {
                    ...
                    b.Property<string>("SiteAccountThemeColorPrimary");

                    b.Property<string>("SiteAccountThemeColorSecondary");

                    b.Property<int>("SiteAccountType");
                    ...
                    b.HasData(
                        new { ID = new Guid("4a93afc2-8ef0-4d91-9374-67e60fc336a8"), CreatedUTC = new DateTime(2018, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, LastUpdatedUTC = new DateTime(2018, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), SiteAccountName = "Awesome Possum Admins", SiteAccountThemeColorPrimary = "#01579b", SiteAccountThemeColorSecondary = "#8d6e63", SiteAccountType = 0 },
                        new { ID = new Guid("6b93aaaa-8ef0-4d91-9574-fae60fc336a8"), CreatedUTC = new DateTime(2018, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), IsActive = true, LastUpdatedUTC = new DateTime(2018, 6, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), SiteAccountName = "Rob's Raspberries", SiteAccountThemeColorPrimary = "#004d40", SiteAccountThemeColorSecondary = "#bf360c", SiteAccountType = 1 }
                    );
                });
            ...
            modelBuilder.Entity("ipman.shared.Entity.FaceCollection", b =>
                {
                    b.HasOne("ipman.shared.Entity.Person", "Person")
            ...
            modelBuilder.Entity("ipman.shared.Entity.FaceImage", b =>
                {
                    b.HasOne("ipman.shared.Entity.FaceCollection", "FaceCollection")
                        .WithMany("FaceImages")
                        .HasForeignKey("FaceCollectionID")
                        .OnDelete(DeleteBehavior.Restrict);
                });
